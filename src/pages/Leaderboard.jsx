    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-gray-500 text-sm mt-1">Top performing traders this month.</p>
        </div>
          ...
          <table className="w-full">
            <thead className="bg-gray-50">
              <tr>
                ...
                <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider hidden sm:table-cell">Win Rate</th>
                <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider hidden md:table-cell">Trades</th>
                <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider hidden md:table-cell">Followers</th>
                <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Action</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-gray-100">
              {traders.map((trader) => (
                <tr key={trader.rank} className="hover:bg-gray-50 transition-colors">
                  <td className="px-4 py-3 text-sm">
                    <span className="text-lg">{trader.badge}</span>
                  </td>
                  <td className="px-4 py-3 text-sm font-medium text-gray-900">{trader.name}</td>
                  <td className="px-4 py-3 text-sm font-semibold text-green-600">{trader.returns}</td>
                  <td className="px-4 py-3 text-sm text-gray-600 hidden sm:table-cell">{trader.winRate}</td>
                  <td className="px-4 py-3 text-sm text-gray-600 hidden md:table-cell">{trader.trades}</td>
                  ...
                  <td className="px-4 py-3 text-sm">
                    <button className="px-3 py-1.5 text-indigo-600 hover:bg-indigo-50 rounded-lg text-sm font-medium transition-colors flex items-center gap-1">
