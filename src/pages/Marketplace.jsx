            ...
            >
              ...
              <div className="h-24 flex items-center justify-center relative">
                <Activity className={`w-10 h-10 group-hover:scale-110 transition-transform ${
                  strategy.verified ? 'text-purple-400 dark:text-purple-500' : 'text-emerald-400 dark:text-emerald-500'
                }`} />
                <div className="absolute top-3 left-3 flex items-center gap-2">
                  {strategy.verified && (
                    <span className="text-xs text-purple-400 dark:text-purple-500 font-medium flex items-center gap-1">
                      <BadgeCheck className="w-3 h-3" />
                      Verified
                    </span>
                  )}
                </div>
                <span className="absolute top-3 right-3 text-xs text-gray-500 dark:text-gray-400 font-medium">
                  {strategy.category}
                </span>
              </div>
              ...
              <div className="p-4">
                ...
                <div className="flex items-center justify-between">
                  <button className="text-purple-500 dark:text-purple-400 text-sm font-bold hover:text-purple-600 dark:hover:text-purple-300 transition-colors">
                    Purchase
                  </button>
                  <button
            ...
            >
              ...
              <div className="flex-1 overflow-y-auto p-5 space-y-5">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-2xl font-bold text-purple-500 dark:text-purple-400">{selectedListing.price} coins</span>
                </div>
                ...
                {selectedListing.verified && (
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-sm font-medium text-purple-500 dark:text-purple-400">Verified Strategy</p>
                      <p className="text-xs text-gray-500 dark:text-gray-400">Reviewed and verified by our team</p>
                    </div>
                  </div>
                )}
              </div>
              ...
              <div className="p-5 border-t border-gray-100 dark:border-gray-800">
                <button className="w-full py-3 text-purple-500 dark:text-purple-400 font-bold text-lg hover:text-purple-600 dark:hover:text-purple-300 transition-colors flex items-center justify-center gap-2">
