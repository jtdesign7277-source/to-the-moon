...
export default function Auth({ onSuccess, onBack, onAdminAccess, initialMode }) {
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-purple-100 via-indigo-50 to-purple-100 flex items-center justify-center px-4 py-8">
      {/* Back button */}
      <button
        onClick={onBack}
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          <div className="text-center mb-6">
            <div className="inline-flex items-center justify-center w-16 h-16 bg-linear-to-br from-indigo-500 to-purple-600 rounded-2xl mb-4 shadow-lg shadow-indigo-500/25">
