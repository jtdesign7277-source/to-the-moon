...
const INITIAL_TRADE_HISTORY = [
  {
    id: 'trade-001',
    ticker: 'SPY-500',
    event: 'S&P 500 closes above 5000',
    platform: 'Kalshi',
    position: 'YES',
    contracts: 100,
    entryPrice: 0.55,
    ...
    pnl: 45.00,
    pnlPercent: 81.8,
    placedAt: new Date(Date.now() - 3600000 * 168),
  ...
  },
  {
    id: 'trade-002',
    ticker: 'NVDA-Q3',
    event: 'NVIDIA beats Q3 earnings',
    platform: 'Polymarket',
    position: 'YES',
    contracts: 150,
    entryPrice: 0.78,
    ...
    pnl: 33.00,
    pnlPercent: 28.2,
    placedAt: new Date(Date.now() - 3600000 * 240),
    settledAt: new Date(Date.now() - 3600000 * 72),
    status: 'won',
    strategy: 'News Catalyst',
    outcome: 'YES',
  },
  {
    id: 'trade-003',
    ticker: 'RAIN-NYC',
    event: 'Rain in NYC on October 15',
    platform: 'Kalshi',
    position: 'NO',
    contracts: 50,
    entryPrice: 0.40,
    ...
    pnl: -20.00,
    pnlPercent: -50.0,
    placedAt: new Date(Date.now() - 3600000 * 360),
    settledAt: new Date(Date.now() - 3600000 * 120),
    status: 'lost',
    strategy: 'Weather',
    outcome: 'YES',
  },
