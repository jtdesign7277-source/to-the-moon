            ...
            {isExpanded ? (
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-bold text-sm text-gray-900 dark:text-white whitespace-nowrap">STRATIFY</span>
                </div>
                <button
                  onClick={() => setIsExpanded(false)}
                  className="w-7 h-7 flex items-center justify-center hover:bg-gray-100 dark:hover:bg-gray-800 rounded-lg transition-colors"
                  title="Collapse menu"
                >
              ...
              <div className="flex flex-col items-center">
                <button
                  onClick={() => setIsExpanded(true)}
                  className="w-8 h-8 border-2 border-indigo-500 rounded-lg flex items-center justify-center hover:bg-indigo-50 dark:hover:bg-indigo-900/30 transition-colors"
                  title="Expand menu"
                >
                  <Rocket className="w-5 h-5 text-indigo-600" strokeWidth={1.5} />
                </button>
          ...
          >
            ...
            {exploreItems.length > 0 && (
              <>
                ...
                {!isExpanded && <div className="my-2 mx-2 border-t border-gray-200 dark:border-gray-700" />}
                <div className="space-y-0.5">
